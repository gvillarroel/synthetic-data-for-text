...
\begin{listing}[H]
\inputminted[
    firstline=41, lastline=42
    ]{python}{../../notebooks/economicos_run.py}
\caption{Obtención de métricas}
...
Los Scores calculados corresponden a la Distancia al registro más cercano (DCR), para visualizar los resultados se muestra un código de ejemplo en la \fullref{codigo-show-score} y el resultado de ese código se muestra en la \fullref{tabla-ejemplo-score}.
