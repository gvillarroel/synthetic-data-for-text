...
\section{Privacidad y sus metricas}
...
Es cierto que existen metricas y tecnicas mencionadas en el marco teorico. Estas no figuran, primero por razones practicas, ya que los metodos establecidos para comprobar la privacidad por SDMetrics y el modelo de diffusión son las anteriores descritas y no otras las usadas y en segunda instancia por el objetivo de las tecnicas de privacidad diferencial \emph{(Differential Privacy)} y k-\emph{anonymity}.
