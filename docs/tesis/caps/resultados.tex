...
\input{datasets/economicos-a-2/tables/table-example-economicos-a-2-smote-enc-1p.tex}
...
\newpage
\input{datasets/economicos-b-2/tables/table-example-economicos-b-2-smote-enc-min.tex}
\input{datasets/economicos-b-2/tables/table-example-economicos-b-2-tddpm_mlp-1p.tex}
\newpage
...
\newpage
\input{datasets/economicos-b-2/tables/table-example-economicos-b-2-smote-enc-1p.tex}
\newpage
